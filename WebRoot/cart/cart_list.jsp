						...
						<s:if test="#item.buy">
							<tr class='td_no_bord'>
								<td style='display: none'>
									<s:property value="#item.product.id" />
								</td>
								<td class="buy_td_6">
									<span class="objhide"><img /> </span>
								</td>
								<td>
									<a href="#"><s:property value="#item.product.productName" />
									</a>
								</td>
								<td class="buy_td_5">
									<span class="c_gray">￥<s:property
											value="#item.product.fixedPrice" /> </span>
								</td>
								<td class="buy_td_4">
									&nbsp;&nbsp;
									<span>￥<s:property value="#item.product.dangPrice" /> </span>
								</td>
								<td class="buy_td_1">
									&nbsp;&nbsp;
								...
								<td>
									<input  class="del_num" type="text" size="3" maxlength="4"
										id="delnum_<s:property value="#item.product.id"/>" />
									<a href="javascript:;"
				...
				<div class="choice_balance">
					...
					<div class="total_balance">
						<div class="save_total">
							您共节省：
							<span class="c_red"> ￥<span id="total_economy">${ecoPrice}</span>
							</span>
							<span id='total_vip_economy' class='objhide'> ( 其中享有优惠： <span
								class="c_red"> ￥<span id='span_vip_economy'></span> </span> ) </span>
						...
						<tbody>
							...
							<tr>
								...
								<td width="365" class=t2>
									<a href="#"><s:property value="#item.product.productName" /></a>
								</td>
								<td width="106" class=buy_td_5>
									￥<s:property
											value="#item.product.fixedPrice" />
								</td>
								<td width="134" class=buy_td_4>
									<span>￥<s:property value="#item.product.dangPrice" /></span>
								</td>
								<td width="56" class=buy_td_1>
									<a href="javascript:;" onclick="location='recovery.action?id=<s:property value="#item.product.id"/>';" >恢复</a>
								</td>
